angular.module('ayelet').controller('rotenbergController', ['$scope', 'rotenbergPaymentService', 'rotenbergOrderService', function ($scope, rotenbergPaymentService, rotenbergOrderService) {
    ...
    $scope.search = () => {
        $scope.orders = rotenbergOrderService.getOrders($scope.searchTerm);
        $scope.payments = rotenbergPaymentService.getPayments($scope.searchTerm);
